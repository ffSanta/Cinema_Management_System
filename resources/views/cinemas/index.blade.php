...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0"><i class="bi bi-building"></i> จัดการโรงภาพยนตร์</h2>
            ...
            <div class="modal-content">
                <form id="cinemaForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="name" class="form-label">ชื่อโรงภาพยนตร์ <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="name" name="name">
                            <div class="invalid-feedback" data-field="name"></div>
                        </div>

                        <div class="mb-3">
                            <label for="total_seats" class="form-label">จำนวนที่นั่ง <span class="text-danger">*</span></label>
    ...
    $(function () {
        ...
        const table = $('#cinemasTable').DataTable({
            ...
            columns: [
                ...
                { data: 'total_seats', className: 'text-center' },
                { data: 'created_at' },
                {
                    data: 'id',
                    orderable: false,
